...
import jsonData from './proxies.json';


// How to generate your own UUID:
// [Windows] Press "Win + R", input cmd and run:  Powershell -NoExit -Command "[guid]::NewGuid()"
let userID = '799241d5-b2a6-4004-824b-e1d8a549c1ba';

const proxyIPs = jsonData;
let proxyIP = proxyIPs[Math.floor(Math.random() * proxyIPs.length)].trim();
